# Cybersecurity Classroom Hub

A responsive classroom landing page for cybersecurity announcements,
resources, readings, and vocabulary.

## GitHub Pages

Pushes to `main` deploy automatically to:

<https://timothy815.github.io/cybersecurity101/>

The Pages workflow runs the dedicated `npm run build:pages` static export. The
existing Vinext/Cloudflare build remains available through `npm run build`.
