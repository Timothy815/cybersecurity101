...
const resources = [
  ...
  ["Linux Commands Reference Handout", "Keep essential Linux navigation, file-management, permissions, process, and networking commands close at hand.", "Reference Guide", "/resources/linux-commands-reference-handout.pdf"],
];
const terms = [
