...
const currentDispatchPath = "/dispatch/to-learn-it-teach-it";
...
export default function Home(){
  ...
  return <main id="top">
    ...
    <section className="hero">
      ...
      <aside className="brief"><div className="brief-top"><span>Current briefing</span><b>ED. 04</b></div><div className="brief-body"><small>August // Current brief</small><h2>To Learn It, Teach It</h2><p>Why explaining an idea may be the clearest test of whether you truly understand it.</p></div><dl><div><dt>Focus</dt><dd>Learning strategies</dd></div><div><dt>Read</dt><dd>8 minutes</dd></div><div><dt>Status</dt><dd className="ready">● Ready</dd></div></dl><Link href={currentDispatchPath}>Open full dispatch <span>→</span></Link></aside>
    </section>
    ...
    <section className="section dispatch" id="dispatch"><div className="section-head compact"><div><p className="label">01 // Classroom dispatch</p><h2>Ideas worth <em>examining.</em></h2></div></div><div className="dispatch-grid">
      <article className="dispatch-main"><div className="meta"><span>Latest edition</span><span>August 16, 2026</span><span>8 min read</span></div><h3>To Learn It, Teach It</h3><p>The Feynman Technique turns explanation into a test of understanding. Study an idea, teach it in your own words, find where the explanation breaks, and return with a better question.</p><div className="steps"><div><b>01</b><p><strong>Explain</strong>Put the source away and teach the idea in your own words.</p></div><div><b>02</b><p><strong>Find</strong>Notice the gap where your explanation becomes uncertain.</p></div><div><b>03</b><p><strong>Refine</strong>Investigate, simplify without distorting, and explain again.</p></div></div><Link className="dark-button" href={currentDispatchPath}>Read full dispatch →</Link></article>
